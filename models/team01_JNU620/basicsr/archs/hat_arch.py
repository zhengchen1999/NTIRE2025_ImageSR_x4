...
from models.team01_PMELSR.basicsr.utils.registry import ARCH_REGISTRY
from models.team01_PMELSR.basicsr.archs.arch_util import to_2tuple, trunc_normal_
from models.team01_PMELSR.basicsr.archs.local_arch import Local_Base
...
# --------------------------------
def forward_x3(lr_img, forward_function=None):
    def _transform(v, op):
...
class HAT(nn.Module):
    ...
    def forward(self, x):
        ...
        output = forward_x3(x, self.forward_once)
